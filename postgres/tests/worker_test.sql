...
PREPARE insert_worker_org_null AS INSERT INTO Worker VALUES (10, 'Worker10', NULL, NULL);
-- 12
SELECT throws_ok('insert_worker_org_null');
-- 13
SELECT results_eq(
    'SELECT * FROM Worker',
     $$VALUES  (1, 'Worker1', 1, NULL),
...
PREPARE update_worker_org_null AS
    UPDATE Worker
    SET (id, worker_name, org_id, head_id) = (8, 'Worker10',NULL,NULL)
    WHERE id = 8;
-- 20
SELECT throws_ok('update_worker_org_null');
-- 21
SELECT results_eq(
    'SELECT * FROM Worker',
     $$VALUES  (1, 'Worker1', 1, NULL),
