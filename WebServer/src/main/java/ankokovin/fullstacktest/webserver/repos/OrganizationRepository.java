        ...
        try {
            ...
            if (message == null) throw ex;
                ...
                if (message.contains("from table \"organization\"")) {
                    throw new DeleteHasChildException(child_id, ankokovin.fullstacktest.webserver.models.Table.ORGANIZATION, ex);
                }
                if (message.contains("from table \"worker\"")) {
                    throw new DeleteHasChildException(child_id, ankokovin.fullstacktest.webserver.models.Table.WORKER, ex);
                }
